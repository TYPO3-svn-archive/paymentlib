...
define('TX_PAYMENTLIB_TRANSACTION_RESULT_SCRIPT_OK', 311);
define('TX_PAYMENTLIB_TRANSACTION_RESULT_INTERNAL_ERROR', 320);

define('TX_PAYMENTLIB_GATEWAYMODE_FORM', 400);
define('TX_PAYMENTLIB_GATEWAYMODE_WEBSERVICE', 401);

define('TX_PAYMENTLIB_TRANSACTION_STATE_NO_PROCESS', 000);
...
define('TX_PAYMENTLIB_TRANSACTION_MESSAGE_NOT_PROCESSED', 000);
 ...
 */
interface tx_paymentlib_provider_int {
